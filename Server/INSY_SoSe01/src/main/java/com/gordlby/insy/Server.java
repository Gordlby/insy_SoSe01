        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    PreparedStatement stDetail = conn.prepareStatement("SELECT c.name, o.id, count(*), sum(l.amount * a.price)  FROM clients c, orders o, order_lines l, articles a WHERE a.id = l.article_id and c.id = o.client_id and o.id = l.order_id and c.country = ? GROUP BY o.id, c.name");
